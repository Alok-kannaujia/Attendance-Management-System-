...
include '../Includes/Deletemodule.php';
  ...
  <section class=main>
   ...
   <div class="table-container">
            <a href="#add-form" style="text-decoration:none;"> <div class="title" id="addLecture">
                    ...
                    <button class="add"><i class="ri-add-line"></i>Add Lecturer</button>
                </div>
            </a>
                <div class="table">
                    <table>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <td>
                                <form action="" method="post">
                                    ...
                                    <button type="submit" class="delete-btn" name="delete_record">
...
<div id="addLectureForm"  style="display:none; ">
    <form method="POST" action="" name="addLecture" enctype="multipart/form-data">
        ...
        <input type="submit" class="submit" value="Save Lecturer" name="addLecture">
    </form>		  
</div>
